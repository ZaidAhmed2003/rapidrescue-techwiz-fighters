  ...
  <div class="boxed_wrapper ltr">
    ...
    <div class="switcher">
      <div class="switch_btn">
        <button>
          <img
            src="assets/images/icon/color-palette.png"
            alt="Color Palette" />
        </button>
      </div>
          ...
          <ul id="styleOptions" title="switch styling">
            ...
            <li>
              <a
                href="javascript: void(0)"
                data-theme="violet"
                class="violet-color"></a>
            </li>
            <li>
              <a
                href="javascript: void(0)"
                data-theme="crimson"
                class="crimson-color"></a>
            </li>
            <li>
              <a
                href="javascript: void(0)"
        ...
        <div class="banner-carousel owl-theme owl-carousel">
          ...
          <div class="slide">
            <div
              class="image-layer"
              style="
                  background-image: url(assets/images/slides/slide-v1-1.jpg);
                "></div>
            <div class="auto-container">
              <div class="content">
                <div class="sub-title">
          ...
          <div class="slide">
            <div
              class="image-layer"
              style="
                  background-image: url(assets/images/slides/slide-v1-2.jpg);
                "></div>
            <div class="auto-container">
              <div class="content">
                <div class="sub-title">
          ...
          <div class="slide">
            <div
              class="image-layer"
              style="
                  background-image: url(assets/images/slides/slide-v1-3.jpg);
                "></div>
            <div class="auto-container">
              <div class="content">
                <div class="sub-title">
    ...
    <section id="services" class="service-style1-area">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-4">
            <div
              class="single-service-style1 wow fadeInDown"
              data-wow-delay="100ms"
              data-wow-duration="1500ms">
              <div class="img-holder">
              ...
              <div class="text-holder">
                <h3><a href="#">Medical Flight Services</a></h3>
                <p>
                  Lorem ipsum is simply dolor sit am adipi we help you ensure
                  everyone.
                </p>
        ...
        <div class="row">
          ...
          <div class="col-xl-5 col-lg-12">
            <div class="slogan-text-box">
              <h2>
                Find out Why Patients Trust<br />
                Our Ambulance
              </h2>
              <h4>
                Call anytime <a href="tel:123456789">+ 1- (246) 333-0089</a>
              </h4>
            </div>
          </div>
